...
par = {
    ...
    # gFF model
    'variable_stim'         : True,
    'forward_shape'         : [900,400,400], #[900,300,150,80]
    'n_inter'               : 100,
    'n_latent'              : 12, #6,
    'n_layer'               : 12,
    ...
    # Training specs
    'batch_size'            : 512,
    'n_train_batches'       : 2500001,
    'n_train_batches_full'  : 3000001,
    'n_train_batches_gen'   : 3000001,
...
def update_dependencies():
    ...
    par['latent_target'] = np.zeros((2*par['batch_size'], 2), dtype = np.float32)
    par['latent_target'][:par['batch_size'],0] = 1.
    par['latent_target'][par['batch_size']:,1] = 1.
